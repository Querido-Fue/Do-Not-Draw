Shader "DoNotDraw/BackroomsWorldSurface"
{
    Properties
    {
        _BaseMap("Surface Albedo", 2D) = "white" {}
        _BaseColor("Tint", Color) = (1, 1, 1, 1)
        _WorldTiling("World Tiling (Tiles Per Meter)", Range(0.1, 8.0)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                TriplanarCoordinates coordinates = GetTriplanarCoordinates(input.positionWS, normalWS);
